...
with open(csv_file_path, 'r') as file:
    ...
    csv_reader = csv.DictReader(file)
    # CSV file path
    output_file_path = "/Users/ranjithrreddyabbidi/ranjith/output.xml"
    ...
    with open(output_file_path, 'w') as output_file:
        ...
        for csv_dict in csv_reader:
            ...
            for elem in tx_dtls:
                ...
                if rpt_submitg_ntty_element1 is not None:
                    lei_value = rpt_submitg_ntty_element1.find('.//ns3:LEI', namespaces=ns).text.strip()
            ...
            if matching_data is not None:
                ...
                if unq_tx_idr_element is not None and unq_tx_idr_element.text == "NK040824243049TC99999SEUREFIT51547XCOMNEGR93":
                    ...
                    output_file.write("UnqTxIdr not found.\n")
            else:
                output_file.write("No matching data found in XML.\n")
